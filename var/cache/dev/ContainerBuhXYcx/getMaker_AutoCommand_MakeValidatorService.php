...
include_once $this->targetDirs[3].'/vendor/antcto/maker-bundle/src/Maker/MakeValidator.php';

$this->privates['maker.auto_command.make_validator'] = $instance = new \AntCTO\Bundle\MakerBundle\Command\MakerCommand(new \AntCTO\Bundle\MakerBundle\Maker\MakeValidator(), ($this->privates['maker.file_manager'] ?? $this->load('getMaker_FileManagerService.php')), ($this->privates['maker.generator'] ?? $this->load('getMaker_GeneratorService.php')));
