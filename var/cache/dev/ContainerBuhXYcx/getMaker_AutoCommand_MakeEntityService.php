...
include_once $this->targetDirs[3].'/vendor/antcto/maker-bundle/src/InputAwareMakerInterface.php';
include_once $this->targetDirs[3].'/vendor/antcto/maker-bundle/src/Maker/MakeEntity.php';
...
$this->privates['maker.auto_command.make_entity'] = $instance = new \AntCTO\Bundle\MakerBundle\Command\MakerCommand(new \AntCTO\Bundle\MakerBundle\Maker\MakeEntity($a, ($this->privates['maker.doctrine_helper'] ?? $this->load('getMaker_DoctrineHelperService.php')), $this->targetDirs[3], $b), $a, $b);
