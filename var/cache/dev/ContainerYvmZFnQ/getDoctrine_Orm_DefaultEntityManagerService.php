...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), [0 => ($this->targetDirs[3].'/core/Entity')]), 'AntCTO\\Entity');

$a->setEntityNamespaces(['AntCTO' => 'AntCTO\\Entity']);
...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    'AntCTO\\Repository\\DemoRepository' => ['privates', 'AntCTO\\Repository\\DemoRepository', 'getDemoRepositoryService.php', true],
])));
