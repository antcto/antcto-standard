 ...
 */
class coreAntCTO_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'AntCTO\\AdminController\\RegistrationController' => 'getRegistrationControllerService.php',
            'AntCTO\\AdminController\\SecurityController' => 'getSecurityControllerService.php',
            'AntCTO\\Theme\\Controller\\DemoController' => 'getDemoControllerService.php',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('console.error', [0 => function () {
            return ($this->privates['maker.console_error_listener'] ?? ($this->privates['maker.console_error_listener'] = new \AntCTO\Bundle\MakerBundle\Event\ConsoleErrorSubscriber()));
        }, 1 => 'onConsoleError'], 0);
        $instance->addListener('console.terminate', [0 => function () {
            return ($this->privates['maker.console_error_listener'] ?? ($this->privates['maker.console_error_listener'] = new \AntCTO\Bundle\MakerBundle\Event\ConsoleErrorSubscriber()));
    ...
    protected function getTwigService()
    {
        ...
        $a->addPath(($this->targetDirs[3].'/core/AdminTemplate'), 'admin_theme');
        ...
        $a->addPath(($this->targetDirs[3].'/vendor/symfony/security-bundle/Resources/views'), '!Security');
        $a->addPath(($this->targetDirs[3].'/theme/Template/default'));

        $this->services['twig'] = $instance = new \Twig\Environment($a, ['default_path' => ($this->targetDirs[3].'/theme/Template/default'), 'paths' => [($this->targetDirs[3].'/core/AdminTemplate') => 'admin_theme'], 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception::showAction', 'form_themes' => $this->parameters['twig.form.resources'], 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'date' => ['format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL], 'number_format' => ['decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',']]);
    ...
    {
        switch ($name) {
            case 'kernel.root_dir': $value = ($this->targetDirs[3].'/core'); break;
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'MakerBundle' => [
                    'path' => ($this->targetDirs[3].'/vendor/antcto/maker-bundle/src'),
                    'namespace' => 'AntCTO\\Bundle\\MakerBundle',
                ],
                'DoctrineCacheBundle' => [
            ...
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/coreAntCTO_KernelDevDebugContainer.xml'); break;
            case 'twig.default_path': $value = ($this->targetDirs[3].'/theme/Template/default'); break;
            case 'doctrine.orm.proxy_dir': $value = ($this->targetDirs[0].'/doctrine/orm/Proxies'); break;
            case 'doctrine_migrations.dir_name': $value = ($this->targetDirs[3].'/core/Migrations'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'MakerBundle' => 'AntCTO\\Bundle\\MakerBundle\\MakerBundle',
            ...
            'kernel.container_class' => 'coreAntCTO_KernelDevDebugContainer',
            ...
            'router.cache_class_prefix' => 'coreAntCTO_KernelDevDebugContainer',
