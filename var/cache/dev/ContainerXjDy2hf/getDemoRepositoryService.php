...
// Returns the private 'AntCTO\Repository\DemoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/core/Repository/DemoRepository.php';

return $this->privates['AntCTO\Repository\DemoRepository'] = new \AntCTO\Repository\DemoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
